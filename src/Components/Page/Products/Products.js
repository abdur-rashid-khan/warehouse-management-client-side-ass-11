...
const Products = () => {
  ...
  return (
    <div className="container mx-auto px-2 py-10">
      ...
      <Link to={'/products'} className='text-lg bg-blue-700 p-2 text-slate-100 rounded px-8'>see more <span><ArrowRightIcon style={{width:'25px',height:'25px',display:'inline-block'}} /></span></Link>
      </div>
    </div>
